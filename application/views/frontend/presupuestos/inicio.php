		...
		<ul class="sf-menu" id="example">
			...
			<li class="current">		
				...
				<ul>
					...
					<li class="current">
						<a href="<?php echo base_url() . 'index.php/presupuestos/abrirPresupuesto/'; ?>"><i class="fa fa-folder-open-o"></i> Abrir</a>						
					</li>
					<li class="current">
...
--------------------------------------------------------------------->
	...
	<?php 	}//cierra el foreach de los articulos
			}else{//si no encuentra articulos muestra cartel
		?>
